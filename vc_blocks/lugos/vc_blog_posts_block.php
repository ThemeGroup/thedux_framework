					...
					?>
						<div class="shortcode__latest-post col-md-12 col-sm-12 masonry__item">
							...
							<div class="latest-post__body text-center">
								...
								<p class="latest-post__bottom"><a href="<?php the_permalink() ?>" class="btn btn--border btn--sm ajax-link"><?php esc_html_e('Read More','lugos') ?></a> </p>
							</div>
						</div>
					<?php
					endwhile;	
					...
					?>
						<div class="shortcode__latest-post <?php echo $blog_columns ?> masonry__item">
							<div class="blog-content">
								...
								<p><?php echo wp_trim_words( get_the_content(), 20 ); ?> <a href="<?php the_permalink() ?>"><?php esc_html_e('More','lugos') ?> ➜</a></p>
							</div>
						</div>
					<?php
					endwhile;	
				...
				<div class="slide-item">
					<div class="shortcode__latest-post">
						...
						<div class="latest-post__body text-center">
							...
							<p class="latest-post__bottom"><a href="<?php the_permalink() ?>" class="btn btn--border btn--sm"><?php esc_html_e('Read More','lugos') ?></a> </p>
						</div>
					</div>
				</div>
...
add_shortcode( 'lugos_blog_posts', 'thedux_blog_posts_shortcode' );
...
function thedux_blog_posts_shortcode_vc() {
	...
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
			"name" => esc_html__("Blog Posts", 'lugos'),
			"base" => "lugos_blog_posts",
