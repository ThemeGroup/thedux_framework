...
add_shortcode( 'lugos_modal_gallery_wide', 'thedux_modal_gallery_wide_shortcode' );
...
add_shortcode( 'lugos_modal_gallery_wide_content', 'thedux_modal_gallery_wide_content_shortcode' );
...
function thedux_modal_gallery_wide_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
		    'name'                    => esc_html__( 'Modal Gallery Wide' , 'lugos' ),
		    'base'                    => 'lugos_modal_gallery_wide',
		    'description'             => esc_html__( 'Create a filter gallery of modal content', 'lugos' ),
		    'as_parent'               => array('only' => 'lugos_modal_gallery_wide_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function thedux_modal_gallery_wide_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
		    'name'            => esc_html__('Modal Gallery Wide Content', 'lugos'),
		    'base'            => 'lugos_modal_gallery_wide_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'lugos' ),
		    "category" => esc_html__('Lugos Theme', 'lugos'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'lugos_modal_gallery_wide'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_lugos_modal_gallery_wide extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_lugos_modal_gallery_wide_content extends WPBakeryShortCode {}
}