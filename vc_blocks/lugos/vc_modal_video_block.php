...
add_shortcode( 'lugos_video_modal', 'thedux_video_modal_shortcode' );
...
function thedux_video_modal_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
			"name" => esc_html__("Video Modal Embeds", 'lugos'),
			"base" => "lugos_video_modal",
			...
			"params" => array(
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Icon Color", 'lugos'),
					"param_name" => "colour",
					"value" => array(
