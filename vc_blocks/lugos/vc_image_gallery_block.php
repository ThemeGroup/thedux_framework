...
add_shortcode( 'lugos_image_gallery', 'thedux_image_gallery_shortcode' );
...
add_shortcode( 'lugos_image_gallery_content', 'thedux_image_gallery_content_shortcode' );
...
function thedux_image_gallery_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
		    'name'                    => esc_html__( 'Lightbox Gallery' , 'lugos' ),
		    'base'                    => 'lugos_image_gallery',
		    'description'             => esc_html__( 'Create a filter gallery of lightbox images', 'lugos' ),
		    'as_parent'               => array('only' => 'lugos_image_gallery_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function thedux_image_gallery_content_shortcode_vc() {
	vc_map( 
		array(
		    ...
		    'base'            => 'lugos_image_gallery_content',
		    'description'     => esc_html__( 'Lightbox Gallery Content Element', 'lugos' ),
		    "category" => esc_html__('Lugos Theme', 'lugos'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'lugos_image_gallery'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_lugos_image_gallery extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_lugos_image_gallery_content extends WPBakeryShortCode {}
}