...
add_shortcode( 'lugos_modal', 'thedux_modal_shortcode' );
...
function thedux_modal_shortcode_vc() {
	...
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
		    'name'                    => esc_html__( 'Modal' , 'lugos' ),
		    'base'                    => 'lugos_modal',
		    'description'             => esc_html__( 'Create a modal popup', 'lugos' ),
		    ...
		    'params' => array(
		    	array(
		    		"type" => "thedux_icons",
		    		"heading" => __("Button Icon, click to choose", 'lugos'),
		    		"param_name" => "icon",
		    		"value" => $icons,
		    	...
		    	array(
		    		"type" => "dropdown",
		    		"heading" => __("Button Alignment", 'lugos'),
		    		"param_name" => "align",
		    		"value" => array(
		    			'Center' => 'text-center',
		    			'Left' => 'text-left',
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_lugos_modal extends WPBakeryShortCodesContainer {
