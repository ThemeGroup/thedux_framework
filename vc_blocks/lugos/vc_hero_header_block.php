...
add_shortcode( 'lugos_hero', 'thedux_hero_shortcode' );
...
function thedux_hero_shortcode_vc() {
	...
	vc_map( 
		array(
			"icon" => 'lugos-vc-block',
			"name" => esc_html__("Hero Header", 'lugos'),
			"base" => "lugos_hero",
			...
			"params" => array(
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Hero Header Display Type", 'lugos'),
					"param_name" => "layout",
					"value" => array(
				...
				array(
					"type" => "attach_image",
					"heading" => esc_html__("Slide Image", 'lugos'),
					"param_name" => "image"
				),
				array(
					"type" => "dropdown",
					"heading" => __("Hero Height", 'lugos'),
				...
				array(
					"type" => "dropdown",
					"heading" => __("Background Image Overlay Opacity (Default 40%)", 'lugos'),
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Contact Form 7 Form", 'lugos'),
					"param_name" => "shortcode",
					"description" => esc_html__('Choose a contact form 7 form if required.', 'lugos'),
					'value' => $forms
				),
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Use Parallax Scrolling on this element?", 'lugos'),
					"param_name" => "parallax",
					"value" => array(
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Self Hosted Video Background .webm extension", 'lugos'),
					"param_name" => "webm",
					"description" => esc_html__('Please fill all extensions if using a video based header', 'lugos')
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Self Hosted Video Background .mp4 extension", 'lugos'),
					"param_name" => "mpfour",
					"description" => esc_html__('Please fill all extensions if using a video based header', 'lugos')
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Self Hosted Video Background .ogv extension", 'lugos'),
					"param_name" => "ogv",
					"description" => esc_html__('Please fill all extensions if using a video based header', 'lugos')
				),
			)
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_lugos_hero extends WPBakeryShortCodesContainer {}
}