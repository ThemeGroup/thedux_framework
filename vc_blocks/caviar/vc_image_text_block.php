...
add_shortcode( 'caviar_text_image', 'thedux_text_image_shortcode' );
...
function thedux_text_image_shortcode_vc() {
	...
	vc_map( 
		array(
		    ...
		    'name'                    => esc_html__( 'Text & Image' , 'caviar' ),
		    'base'                    => 'caviar_text_image',
		    'description'             => esc_html__( 'Create fancy images & text', 'caviar' ),
		    ...
		    'params' => array(
		    	...
		    	array(
		    		"type" => "dropdown",
		    		"heading" => esc_html__("Image & Text Display Type", 'caviar'),
		    		"param_name" => "layout",
		    		"value" => array(
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_caviar_text_image extends WPBakeryShortCodesContainer {}
}