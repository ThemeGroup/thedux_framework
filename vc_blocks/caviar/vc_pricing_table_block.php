...
add_shortcode( 'caviar_pricing_table', 'thedux_pricing_table_shortcode' );
...
function thedux_pricing_table_shortcode_vc() {
	...
	vc_map( 
		array(
			...
			"name" => esc_html__("Pricing Table", 'caviar'),
			"base" => "caviar_pricing_table",
			...
			"params" => array(
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Currency", 'caviar'),
					"param_name" => "currency"
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Price", 'caviar'),
					"param_name" => "price"
				),
				array(
					"type" => "textfield",
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Pricing Table Display Type", 'caviar'),
					"param_name" => "layout",
					"value" => array(
						'Standard' => 'standard',
