...
add_shortcode( 'caviar_styled_map', 'thedux_styled_map_shortcode' );
...
function thedux_styled_map_shortcode_vc() {
	vc_map(
		array(
			...
			"name" => esc_html__("Styled Google Map", 'caviar'),
			"base" => "caviar_styled_map",
			"category" => esc_html__('Caviar Theme', 'caviar'),
			"params" => array(
				array(
					"type" => "textfield",
					"heading" => esc_html__("Google Maps API Key", 'caviar'),
					"param_name" => "api_key",
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Street Address", 'caviar'),
					"param_name" => "address",
					"description" => "Enter your desired map location street address.",
				),
				array(
					"type" => "textarea_raw_html",
					"heading" => esc_html__("Map Custom Style", 'caviar'),
					"param_name" => "style",
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Extra CSS Class Name", 'caviar'),
