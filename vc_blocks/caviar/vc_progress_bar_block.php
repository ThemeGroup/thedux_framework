...
add_shortcode( 'caviar_skill_bar_block', 'thedux_skill_bar_block_shortcode' );
...
function thedux_skill_bar_block_shortcode_vc() {
	...
	vc_map( 
		array(
			...
			"name" => esc_html__("Progress Bar", 'caviar'),
			"base" => "caviar_skill_bar_block",
			"category" => esc_html__('Caviar Theme', 'caviar'),
			'description' => 'Coloured bars for demonstrating your skills.',
			"params" => array(
				array(
					"type" => "textfield",
					"heading" => esc_html__("Skill Title", 'caviar'),
					"param_name" => "title",
					'holder' => 'div'
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Skill Amount", 'caviar'),
					"param_name" => "amount",
