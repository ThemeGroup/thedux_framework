...
add_shortcode( 'caviar_twitter', 'thedux_twitter_shortcode' );
...
function thedux_twitter_shortcode_vc() {
	vc_map( 
		array(
			...
			"name" => esc_html__("Twitter Feed", 'caviar'),
			"base" => "caviar_twitter",
			"category" => esc_html__('Caviar Theme', 'caviar'),
			"params" => array(
				array(
					"type" => "textfield",
					"heading" => esc_html__("Twitter Username", 'caviar'),
					"param_name" => "username",
					"description" => "Plain text, do not use @",
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Twitter User ID", 'caviar'),
					"param_name" => "title",
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("Load how many tweets? Numeric Only.", 'caviar'),
					"param_name" => "amount",
					'value' => '5',
				),
			)
