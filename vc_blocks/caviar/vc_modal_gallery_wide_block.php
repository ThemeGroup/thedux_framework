 ...
 * The Shortcode
 */
function thedux_modal_gallery_wide_shortcode( $atts, $content = null ) {
	extract( 
		shortcode_atts( 
			array(
				'text' => 'Show All'
...
add_shortcode( 'caviar_modal_gallery_wide', 'thedux_modal_gallery_wide_shortcode' );

/**
 * The Shortcode
 */
function thedux_modal_gallery_wide_content_shortcode( $atts, $content = null ) {
	extract( 
		shortcode_atts( 
			array(
				'class' => '',
...
add_shortcode( 'caviar_modal_gallery_wide_content', 'thedux_modal_gallery_wide_content_shortcode' );

// Parent Element
function thedux_modal_gallery_wide_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'caviar-vc-block',
		    'name'                    => esc_html__( 'Modal Gallery Wide' , 'caviar' ),
		    'base'                    => 'caviar_modal_gallery_wide',
		    'description'             => esc_html__( 'Create a filter gallery of modal content', 'caviar' ),
		    'as_parent'               => array('only' => 'caviar_modal_gallery_wide_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
add_action( 'vc_before_init', 'thedux_modal_gallery_wide_shortcode_vc' );

// Nested Element
function thedux_modal_gallery_wide_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'caviar-vc-block',
		    'name'            => esc_html__('Modal Gallery Wide Content', 'caviar'),
		    'base'            => 'caviar_modal_gallery_wide_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'caviar' ),
		    "category" => esc_html__('Caviar Theme', 'caviar'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'caviar_modal_gallery_wide'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
add_action( 'vc_before_init', 'thedux_modal_gallery_wide_content_shortcode_vc' );

// A must for container functionality, replace Wbc_Item with your base name from mapping for parent container
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_caviar_modal_gallery_wide extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_caviar_modal_gallery_wide_content extends WPBakeryShortCode {}
}